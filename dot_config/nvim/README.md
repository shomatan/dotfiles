...
| `q` | Oilを閉じる | Oil |
| `<leader>ac` | Claude切り替え | claudecode.nvim |
| `<leader>af` | Claudeフォーカス | claudecode.nvim |
| `<leader>ar` | 再開 | claudecode.nvim |
| `<leader>aC` | 継続 | claudecode.nvim |
| `<leader>am` | モデル選択 | claudecode.nvim |
| `<leader>ab` | バッファ追加 | claudecode.nvim |
| `<leader>as` | 選択範囲送信 (visual) | claudecode.nvim |
| `<leader>aa` | 差分受け入れ | claudecode.nvim |
| `<leader>ad` | 差分拒否 | claudecode.nvim |
...
|------|------|
| `gf` | カーソル下のファイルパスを開く |
| `gF` | ファイルを開き、行番号があればその行にジャンプ |
| `<C-w>f` | 水平分割で開く |
| `<C-w>F` | 水平分割で開く + 行番号ジャンプ |
| `<C-w>gf` | 新しいタブで開く |
| `<C-w>gF` | 新しいタブで開く + 行番号ジャンプ |
