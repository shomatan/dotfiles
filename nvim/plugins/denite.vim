...
"" coc
nnoremap <silent><C-d>d :<C-u>Denite coc-diagnostic -split=floating -buffer-name=diagnostic<CR>
" 【Ctrl + d + gd】 diagnosticした結果を再表示
nnoremap <silent><C-d>gd :<C-u>Denite -resume -buffer-name=diagnostic<CR>
